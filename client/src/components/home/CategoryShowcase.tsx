 ...
 */
function PromoCard({ title, subtitle, products = [], viewAllLink, accentColor = '#131921' }: PromoCardProps) {
 ...
 */
export default function CategoryShowcase({ categoryMap = {}, loading = false }: CategoryShowcaseProps) {
  const cards = [
    {
